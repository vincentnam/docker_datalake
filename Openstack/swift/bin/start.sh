...
mkfs.xfs /data_dev/1
mkfs.xfs /data_dev/2
mkdir -p /mnt/1 /mnt/2 #/swift/nodes/3 /swift/nodes/4
...
mkdir -p /srv/1/node/sdb1 /srv/1/node/sdb5 /srv/2/node/sdb2 /srv/2/node/sdb6 /var/run/swift #/srv/3/node/sdb3 /srv/4/node/sdb4

...
ls /internal_dev
echo 
#dd if=/dev/zero of=/internal_dev/swift-storage-d-1 bs=1024k count=10
losetup --find --show /internal_dev/swift-storage-d-1
#/dev/loop0
...
swift-container-server /etc/swift/container/container-1.conf verbose

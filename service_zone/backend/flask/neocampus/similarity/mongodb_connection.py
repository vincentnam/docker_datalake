...
def connection_mongodb(mongodb_url,username,password,authSource):
    try:
...
def insert_indexes_images(connection_mongo,connection_swift,path_csv_indexes,path_director_images):
    ...
    for i in range(len(df)):
        ...
        if name_image_mongo == name_image_swift :
            ...
            swift_connection.set_swift(connection_swift, container_name,str(id_swift),file_content,type_file)
